...
criminal_questions = [
    ...
    {
    "question": "Які стадії вчинення злочину передбачені кримінальним законодавством?",
    "options": [
        "Готування, замах, закінчений злочин",
        "Планування, підготовка, виконання",
        "Умисел, готування, замах",
        "Задум, реалізація, завершення"
    ],
    "correct": 0,
    "explanation": "Відповідно до ККУ виділяють три стадії вчинення злочину: готування до злочину, замах на злочин та закінчений злочин."
},
{
    "question": "Задача: Особа А з метою вбивства Особи Б придбала отруту, але була затримана до її використання. Як кваліфікувати дії?",
    "options": [
        "Замах на вбивство",
        "Готування до вбивства",
        "Незакінчений злочин",
    ...
    "correct": 1,
    "explanation": "Дії кваліфікуються як готування до вбивства, оскільки особа здійснювала підготовчі дії, але ще не почала виконання об'єктивної сторони злочину."
},
{
    "question": "Які форми співучасті передбачені кримінальним законом?",
    "options": [
        "Група осіб, група осіб за попередньою змовою, організована група, злочинна організація",
        "Виконавець, організатор, підбурювач, пособник",
        "Проста співучасть і складна співучасть",
        "Співвиконавство і співорганізація"
    ],
    "correct": 0,
    "explanation": "ККУ передбачає чотири форми співучасті: вчинення злочину групою осіб, групою осіб за попередньою змовою, організованою групою та злочинною організацією."
},
{
    "question": "Задача: Особа А в темний час доби йшла по вулиці. Побачивши силует людини, яка різко дістала з кишені предмет, А вдарила її палицею, спричинивши середньої тяжкості тілесні ушкодження. Виявилось, що це був перехожий, який діставав телефон. Як кваліфікувати дії А?",
    "options": [
        "Умисне тілесне ушкодження середньої тяжкості",
        "Уявна оборона, що виключає відповідальність",
        "Необхідна оборона",
        "Перевищення меж необхідної оборони"
    ],
    "correct": 1,
    "explanation": "Має місце уявна оборона, що виключає кримінальну відповідальність, оскільки обстановка давала особі достатні підстави вважати, що здійснюється реальне посягання."
},
{
    "question": "Які обставини, що виключають злочинність діяння, передбачені ККУ?",
    "options": [
        "Необхідна оборона, крайня необхідність, затримання злочинця",
        "Лише необхідна оборона і крайня необхідність",
        "Необхідна оборона, уявна оборона, виконання наказу",
        "Необхідна оборона, фізичний примус, службова необхідність"
    ],
    "correct": 0,
    "explanation": "Основними обставинами, що виключають злочинність діяння, є необхідна оборона, крайня необхідність та затримання особи, що вчинила злочин."
},
{
    "question": "Задача: Лікар відмовився надати допомогу хворому, посилаючись на відсутність страхового полісу. Внаслідок цього хворий помер. Яка форма вини у діях лікаря щодо смерті пацієнта?",
    "options": [
        "Прямий умисел",
        "Непрямий умисел",
        "Злочинна самовпевненість",
    ...
    "correct": 3,
    "explanation": "У діях лікаря наявна злочинна недбалість, оскільки він не передбачав можливості настання смерті пацієнта, хоча повинен був і міг її передбачити."
},
{
    "question": "Які види множинності злочинів передбачені кримінальним законом?",
    "options": [
        "Повторність, сукупність, рецидив",
        "Повторність і неповторність",
        "Сукупність і повторність",
        "Рецидив і повторність"
    ],
    "correct": 0,
    "explanation": "ККУ передбачає три види множинності злочинів: повторність, сукупність та рецидив злочинів."
},
{
    "question": "Задача: Особа А, знаючи про психічне захворювання Особи Б, переконала її вчинити крадіжку. Як кваліфікувати дії Особи А?",
    "options": [
        "Співучасть у крадіжці",
        "Підбурювання до крадіжки",
        "Посереднє виконання крадіжки",
        "Пособництво у крадіжці"
    ],
    "correct": 2,
    "explanation": "Має місце посереднє виконання злочину, оскільки Особа А використала для вчинення злочину особу, яка не підлягає кримінальній відповідальності через психічне захворювання."
},
{
    "question": "Які види замаху на злочин передбачені кримінальним законом?",
    "options": [
        "Закінчений і незакінчений замах",
        "Простий і складний замах",
        "Умисний і необережний замах",
        "Вдалий і невдалий замах"
    ],
    "correct": 0,
    "explanation": "Кримінальний кодекс передбачає два види замаху: закінчений (особа виконала всі дії, які вважала необхідними) і незакінчений (особа не виконала всіх дій, які вважала необхідними)."
},
{
    "question": "Задача: Особа А завдала удару Особі Б, від якого та впала і вдарилася головою об бордюр, що спричинило смерть. А стверджує, що хотіла лише завдати тілесних ушкоджень. Як кваліфікувати дії?",
    "options": [
        "Умисне вбивство",
    ...
    "correct": 2,
    "explanation": "Дії кваліфікуються як вбивство через необережність, оскільки щодо смерті був відсутній умисел, а наслідки настали через необережність."
},
{
    "question": "У чому полягає відмінність між крайньою необхідністю та необхідною обороною?",
    "options": [
        "Відмінностей немає",
        "При крайній необхідності шкода завдається третім особам, а при необхідній обороні - нападнику",
        "Крайня необхідність виключає кримінальну відповідальність, а необхідна оборона - ні",
        "При необхідній обороні шкода завдається третім особам"
    ],
    "correct": 1,
    "explanation": "Головна відмінність полягає в тому, що при крайній необхідності шкода заподіюється третім особам для усунення небезпеки, а при необхідній обороні шкода заподіюється нападнику."
},
{
    "question": "Задача: 14-річний підліток вчинив крадіжку телефону. Як вирішується питання про його кримінальну відповідальність?",
    "options": [
        "Не підлягає кримінальній відповідальності через вік",
        "Підлягає кримінальній відповідальності на загальних підставах",
        "Застосовуються лише примусові заходи виховного характеру",
        "Відповідальність несуть батьки"
    ],
    "correct": 1,
    "explanation": "За крадіжку кримінальна відповідальність настає з 14 років, тому підліток підлягає кримінальній відповідальності на загальних підставах."
},
{
    "question": "Які види злочинної недбалості передбачені кримінальним законом?",
    "options": [
        "Злочинна самовпевненість і злочинна недбалість",
        "Груба недбалість і проста недбалість",
        "Умисна недбалість і необережна недбалість",
        "Професійна недбалість і побутова недбалість"
    ],
    "correct": 0,
    "explanation": "Кримінальний закон передбачає два види злочинної необережності: злочинну самовпевненість і злочинну недбалість."
},
{
    "question": "Задача: Під час бійки Особа А завдала удару Особі Б, від якого та втратила свідомість. Злякавшись, А залишила потерпілого на морозі, внаслідок чого той помер від переохолодження. Як кваліфікувати дії А?",
    "options": [
        "Умисне вбивство",
        "Вбивство через необережність",
        "Умисне тяжке тілесне ушкодження, що спричинило смерть",
        "Залишення в небезпеці, що спричинило смерть"
    ],
    "correct": 3,
    "explanation": "Дії кваліфікуються як залишення в небезпеці, що спричинило смерть особи, оскільки винний свідомо залишив потерпілого без допомоги в небезпечному для життя стані."
},
{
    "question": "Що таке триваючий злочин?",
    "options": [
        "Злочин, що складається з кількох тотожних діянь",
        "Злочин, що характеризується безперервним здійсненням складу злочину",
        "Злочин, що триває понад один рік",
        "Злочин з тривалою підготовкою"
    ],
    "correct": 1,
    "explanation": "Триваючий злочин характеризується безперервним здійсненням складу злочину (наприклад, незаконне зберігання зброї, ухилення від сплати аліментів)."
}
]
civil_questions = [
    {
    ...
    {
        "question": "Які правові наслідки визнання фізичної особи безвісно відсутньою?",
        "options": [
            "Припинення шлюбу",
            "Передача майна в управління",
            "Оголошення особи померлою",
            "Ліквідація всіх зобов'язань особи"
        ],
        "correct": 1,
        "explanation": "Згідно зі ст. 44 ЦКУ, майно фізичної особи, яка визнана безвісно відсутньою, передається за рішенням суду в управління особі, яка визначається судом."
    },
    {
        "question": "Який строк дії довіреності, якщо він не вказаний у довіреності?",
        "options": [
            "6 місяців",
            "1 рік",
            "3 роки",
        ...
        "correct": 1,
        "explanation": "Відповідно до ст. 247 ЦКУ, якщо у довіреності не вказаний строк її дії, вона зберігає чинність до припинення її дії, але не більше одного року з дня її вчинення."
    },
    {
        "question": "В який строк можна відкликати оферту?",
        "options": [
            "До моменту її отримання адресатом",
            "Протягом 3 днів після відправлення",
            "В будь-який момент до акцепту",
            "Оферту не можна відкликати"
        ],
        "correct": 0,
        "explanation": "Згідно зі ст. 641 ЦКУ, пропозицію укласти договір (оферту) можна відкликати до моменту або в момент її одержання адресатом."
    },
    {
        "question": "Яким є строк для пред'явлення вимог про недоліки проданого товару?",
        "options": [
            "14 днів",
            "6 місяців",
            "1 рік",
        ...
        "correct": 1,
        "explanation": "Відповідно до ст. 681 ЦКУ, покупець має право пред'явити вимогу у зв'язку з недоліками товару за умови, що вони були виявлені в строки, встановлені договором або законом, але не пізніше двох років."
    },
    {
        "question": "Що таке емфітевзис?",
        "options": [
            "Право користування чужою земельною ділянкою для сільськогосподарських потреб",
            "Право на забудову земельної ділянки",
            "Право проходу через чужу земельну ділянку",
            "Право на видобуток корисних копалин"
        ],
        "correct": 0,
        "explanation": "Емфітевзис - це право користування чужою земельною ділянкою для сільськогосподарських потреб, яке встановлюється договором між власником земельної ділянки і особою, яка виявила бажання користуватися цією земельною ділянкою."
    },
    {
        "question": "Які наслідки має прострочення виконання зустрічного зобов'язання?",
        "options": [
            "Договір автоматично розривається",
            "Нараховується пеня",
            "Зобов'язання припиняється",
            "Кредитор має право зупинити виконання свого зобов'язання"
        ],
        "correct": 3,
        "explanation": "Згідно зі ст. 538 ЦКУ, у разі прострочення виконання зобов'язання однією стороною у зустрічному зобов'язанні друга сторона має право зупинити виконання свого зобов'язання."
    },
    {
        "question": "Який максимальний строк договору довічного утримання?",
        "options": [
            "До смерті відчужувача",
            "99 років",
            "50 років",
            "25 років"
        ],
        "correct": 0,
        "explanation": "Договір довічного утримання діє до смерті відчужувача, оскільки це є його сутнісною характеристикою згідно з ЦКУ."
    },
    {
        "question": "Що таке суперфіцій?",
        "options": [
            "Право будівництва на чужій земельній ділянці",
            "Право користування чужим майном",
            "Право на оренду землі",
            "Право на видобуток корисних копалин"
        ],
        "correct": 0,
        "explanation": "Суперфіцій - це право користування чужою земельною ділянкою для забудови, яке виникає на підставі договору або заповіту."
    },
    {
        "question": "Протягом якого строку діє переважне право купівлі частки у праві спільної часткової власності?",
        "options": [
            "1 місяць",
            "2 місяці",
            "3 місяці",
        ...
        "correct": 0,
        "explanation": "Згідно зі ст. 362 ЦКУ, співвласник має право переважної купівлі частки у праві спільної часткової власності протягом одного місяця з дня повідомлення про намір продати частку."
    },
    {
        "question": "Які правові наслідки має визнання правочину недійсним?",
        "options": [
        ...
        "correct": 0,
        "explanation": "У разі недійсності правочину кожна із сторін зобов'язана повернути другій стороні у натурі все, що вона одержала на виконання цього правочину (двостороння реституція)."
    }
]
